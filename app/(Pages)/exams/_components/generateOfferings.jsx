...
import { ArrowRight, Link, Loader, SquareCheckBig } from "lucide-react";
import { useState } from "react";

export const GenerateOfferings = ({
  title,
  items,
  specialMessage,
  examName,
      ...
      <div className="p-4 mt-auto">
        {specialMessage ? (
          ...
          <button
            ...
            } bg-accent w-full flex items-center justify-center rounded-2xl py-5 px-6 text-primary font-semibold hover:bg-accent-dark transition hover:opacity-95`}
          >
            {loading ? (
              <Loader className="animate-spin" />
            ) : (
              <div className="flex items-center justify-center">
                Start Your Preparation <ArrowRight className="ml-2" />
              </div>
            )}
          </button>
        )}
